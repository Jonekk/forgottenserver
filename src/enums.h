...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_CREATION_ITEM = 1 << 27,
...
enum CombatType_t : uint16_t {
	...
	COMBAT_PHYSICALDAMAGE_NO_BLOOD = 1 << 12,
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_STAMINAGAIN = 56,
	CONDITION_PARAM_STAMINATICKS = 57,
	CONDITION_PARAM_HUNGER_TOTAL_TICKS = 58,
};
...
enum ConditionType_t {
	...
	CONDITION_STAMINA_REGEN = 1 << 28,
	CONDITION_HUNGRY = 1 << 29,
};
...
enum ReturnValue {
	...
	RETURNVALUE_CONTAINERTYPEMISMATCH,
